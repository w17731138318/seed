...
insert  into `qrtz_scheduler_state`(`SCHED_NAME`,`INSTANCE_NAME`,`LAST_CHECKIN_TIME`,`CHECKIN_INTERVAL`) values ('SysScheduler','MicroWin10-11501514887281125',1514887943538,15000);
...
insert  into `sys_dept`(`dept_id`,`parent_id`,`name`,`order_num`,`del_flag`) values (1,0,'系统',0,0),(2,1,'石家庄市公安局',1,0),(3,2,'裕华区公安局',0,0),(4,2,'新华区公安局',1,0),(5,2,'桥西区公安局',2,0);
...
insert  into `sys_log`(`id`,`username`,`operation`,`method`,`params`,`time`,`ip`,`create_date`) values (1,'admin','修改用户','com.pasq.modules.sys.controller.SysUserController.update()','{\"userId\":1,\"username\":\"admin\",\"salt\":\"YzcmCZNvbXocrsz9dm8e\",\"email\":\"w17731138318@126.com\",\"mobile\":\"17731138318\",\"status\":1,\"roleIdList\":[],\"createUserId\":1,\"createTime\":\"Nov 11, 2016 11:11:11 AM\",\"deptId\":1,\"deptName\":\"集团\"}',14,'127.0.0.1','2018-01-02 17:43:15');
...
insert  into `sys_user`(`user_id`,`username`,`password`,`salt`,`email`,`mobile`,`status`,`dept_id`,`create_time`) values (1,'admin','9ec9750e709431dad22365cabc5c625482e574c74adaebba7dd02f1129e4ce1d','YzcmCZNvbXocrsz9dm8e','w17731138318@126.com','17731138318',1,1,'2016-11-11 11:11:11');
...
insert  into `sys_user_token`(`user_id`,`token`,`expire_time`,`update_time`) values (1,'6cbb4f9a7069e400b7db1eb668bf79aa','2018-01-03 05:42:21','2018-01-02 17:42:21');
